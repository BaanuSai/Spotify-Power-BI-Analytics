...
client_id = '587a8fa644134bc8a2dd1272dd31f979'
client_secret = '704d537646bf4e6baae8d51fab9b1b4f'

# Get Access Token
access_token = get_spotify_token(client_id, client_secret)
print("Reading CSV file...")
# Read your DataFrame (replace 'your_file.csv' with the path to your CSV file)
df_spotify = pd.read_csv(r'C:\Users\12145\Documents\SkillTrack\Project\PowerBI\spotify-2023.csv', encoding='ISO-8859-1')
